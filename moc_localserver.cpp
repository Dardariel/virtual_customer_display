...
QT_MOC_LITERAL(1, 12, 9), // "signalLog"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 10), // "signalData"
QT_MOC_LITERAL(4, 34, 15) // "slotReadTimeout"

    },
    "LocalServer\0signalLog\0\0signalData\0"
    "slotReadTimeout"
};
...
void LocalServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signalData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 2: _t->slotReadTimeout(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LocalServer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LocalServer::signalLog)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LocalServer::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LocalServer::signalData)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LocalServer::signalLog(QString _t1)
{
...
// SIGNAL 1
void LocalServer::signalData(QByteArray _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
